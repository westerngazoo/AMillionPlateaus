...
export const QC_PLATEAUS = [
  // ── Phase I · Logic (the bootloader) ─────────────────────────────────────
  {
    ...
    domain: CL, e1: 0.95, e2: 0.3, e3: 0.0,
    description:
...
**Deliverable:** state, in Hehner-style predicate notation, what LEM buys you that you lose without it.`,
  },
  {
    ...
    domain: IN, e1: 0.95, e2: 0.0, e3: 0.3,
    description:
...
**Deliverable:** exhibit a Heyting algebra that is not Boolean.`,
  },
  {
    ...
    domain: CL, e1: 0.85, e2: 0.3, e3: 0.15,
    description:
...
**Deliverable:** specify the geometric product as a predicate, and the refinement relation between a reference (bivector-table) and an optimized (bitmask) implementation — formalize what garust already does.`,
  ...
  // ── Phase II · Set theory (two kernels) ──────────────────────────────────
  {
    ...
    name: "ZFC Set Theory",
    domain: CL, e1: 0.95, e2: 0.2, e3: 0.0,
    description:
`# ZFC — the classical kernel
...
**Deliverable:** identify which axiom each step of the ℝ construction actually uses.`,
  },
  {
    ...
    domain: IN, e1: 0.88, e2: 0.0, e3: 0.32,
    description:
`# Topos Theory — the intuitionistic kernel
...
**Deliverable:** state precisely why a smooth topos *cannot* host classical LEM together with nonzero nilsquare infinitesimals.`,
  ...
  // ── Phase III · Numbers (the completion tree) ────────────────────────────
  {
    ...
    domain: CL, e1: 0.9, e2: 0.3, e3: 0.05,
    description:
`# The classical number tower
...
**Deliverable:** complete the decimal expansion of $1/3$ in ℝ and hold it for comparison with the p-adic view.`,
  },
  {
    ...
    domain: CL, e1: 0.82, e2: 0.15, e3: 0.35,
    description:
`# Ostrowski's theorem — the branch point
...
**Deliverable:** compute the 5-adic expansion of $1/3$ beside its decimal expansion.`,
  },
  {
    ...
    domain: CL, e1: 0.85, e2: 0.2, e3: 0.25,
    description:
`# Infinitesimals, the classical way
...
**Deliverable:** state Łoś's theorem and where the ultrafilter/choice enters.`,
  },
  {
    ...
    domain: IN, e1: 0.85, e2: 0.0, e3: 0.38,
    description:
...
**Deliverable:** show $\\varepsilon^2 = 0$ kills every higher-order Taylor term automatically.`,
  ...
  // ── Phase IV · Algebra (why there is no single algebra) ───────────────────
  {
    ...
    domain: CL, e1: 0.95, e2: 0.15, e3: 0.15,
    description:
`# Universal algebra — the spec layer
...
**Deliverable:** write the signature+axioms for a group, then extend to a ring by adding exactly one operation and distributivity.`,
  },
  {
    ...
    domain: CL, e1: 0.9, e2: 0.2, e3: 0.2,
    description:
`# Hurwitz — the hard stop
...
**Deliverable:** verify $\\mathbb{H}$ is normed and division; note where dimension 16 (sedenions) fails.`,
  },
  {
    ...
    domain: CL, e1: 0.8, e2: 0.25, e3: 0.4,
    description:
`# Grassmann (1844) — area without metric
...
**Deliverable:** in $\\Lambda(\\mathbb{R}^3)$, expand $(a_1e_1+a_2e_2+a_3e_3)\\wedge(b_1e_1+b_2e_2+b_3e_3)$ and recognize the cross product.`,
  },
  {
    ...
    domain: CL, e1: 0.78, e2: 0.35, e3: 0.32,
    description:
`# Clifford (1878) — Grassmann + a metric
...
**Deliverable:** derive $Cl(2,0)$ from $v^2=Q(v)$; verify $e_1e_2$ squares to $-1$, recovering ℂ as the even subalgebra.`,
  ...
  // ── Phase V · Analysis rebuilt ────────────────────────────────────────────
  {
    ...
    name: "τ and Rotors",
    domain: CL, e1: 0.72, e2: 0.3, e3: 0.42,
    description:
`# τ, and rotation as a geometric object
...
**Deliverable:** rotate $e_1$ by $\\tau/4$ in the $e_1e_2$ plane using the sandwich product.`,
  },
  {
    ...
    domain: CL, e1: 0.85, e2: 0.25, e3: 0.2,
    description:
`# Three derivatives, three logics
...
**Deliverable:** differentiate $f(x)=x^3$ three ways, get $3x^2$ each time, and say precisely *why* they had to agree here.`,
  ...
  // ── Phase VI · GA physics ─────────────────────────────────────────────────
  {
    ...
    domain: CL, e1: 0.7, e2: 0.45, e3: 0.3,
    description:
`# Geometric algebra as computation
...
**Deliverable:** map each grade of a 3D multivector to its geometric meaning (scalar, vector, bivector, pseudoscalar).`,
  },
  {
    ...
    domain: CL, e1: 0.55, e2: 0.78, e3: 0.15,
    description:
...
**Deliverable:** split $\\nabla F = J/\\varepsilon_0 c$ back into the familiar four by grade.`,
  },
  {
    ...
    domain: CL, e1: 0.6, e2: 0.7, e3: 0.22,
    description:
`# The Dirac equation, real-valued
...
**Deliverable:** identify which bivector of $Cl(1,3)$ plays the role of the imaginary unit.`,
  ...
  // ── Phase VII · Quantum computing ─────────────────────────────────────────
  {
    ...
    name: "Qubit = Spinor",
    domain: CL, e1: 0.62, e2: 0.6, e3: 0.2,
    description:
`# A qubit is a rotor
...
**Deliverable:** place $|0\\rangle, |1\\rangle, |+\\rangle$ on the Bloch sphere as unit vectors a rotor acts on.`,
  },
  {
    ...
    domain: CL, e1: 0.62, e2: 0.55, e3: 0.25,
    description:
`# Single-qubit gates
...
**Deliverable:** write the Hadamard as a rotor $R = e^{-B\\theta/2}$ — find its plane $B$ and angle.`,
  },
  {
    ...
    domain: CL, e1: 0.65, e2: 0.55, e3: 0.2,
    description:
`# The hard extension (flagged honestly)
...
**Deliverable:** state the dimension of the state space for $n$ qubits and where the clean single-qubit rotor picture stops.`,
  ...
  // ── Phase VIII · AI (closing the rhizome) ─────────────────────────────────
  {
    ...
    domain: CL, e1: 0.68, e2: 0.55, e3: 0.28,
    description:
`# AI on the GA substrate
...
export const QC_BRIDGES = [
  // Phase I → II
  { id: "20000000-0000-0000-0000-000000000001", from: Q["Classical Predicate Logic"], to: Q["ZFC Set Theory"], concept: "LEM ⇒ classical sets" },
  { id: "20000000-0000-0000-0000-000000000002", from: Q["Intuitionistic Logic"], to: Q["Elementary Topos Theory"], concept: "internal logic" },
  { id: "20000000-0000-0000-0000-000000000003", from: Q["Classical Predicate Logic"], to: Q["Hehner Predicative Logic"], concept: "predicate calculus" },
  // the fork itself (meet)
  { id: "20000000-0000-0000-0000-000000000004", from: Q["Classical Predicate Logic"], to: Q["Intuitionistic Logic"], concept: "drop LEM (meet)" },
  // Phase II → III / IV
  { id: "20000000-0000-0000-0000-000000000005", from: Q["ZFC Set Theory"], to: Q["The Real Tower ℕ→ℤ→ℚ→ℝ"], concept: "Cauchy/Dedekind" },
  { id: "20000000-0000-0000-0000-000000000006", from: Q["ZFC Set Theory"], to: Q["Universal Algebra"], concept: "structures" },
  { id: "20000000-0000-0000-0000-000000000007", from: Q["Elementary Topos Theory"], to: Q["SIA Infinitesimals (Kock–Lawvere)"], concept: "nilsquare dx²=0" },
  // Phase III internal
  { id: "20000000-0000-0000-0000-000000000008", from: Q["The Real Tower ℕ→ℤ→ℚ→ℝ"], to: Q["Ostrowski & the p-adics"], concept: "completions of ℚ" },
  { id: "20000000-0000-0000-0000-000000000009", from: Q["The Real Tower ℕ→ℤ→ℚ→ℝ"], to: Q["Infinitesimal Systems (ℝ*, Surreals)"], concept: "hyperreals" },
  { id: "20000000-0000-0000-0000-00000000000a", from: Q["Infinitesimal Systems (ℝ*, Surreals)"], to: Q["SIA Infinitesimals (Kock–Lawvere)"], concept: "same spec, two backends (meet)" },
  // Phase IV internal
  { id: "20000000-0000-0000-0000-00000000000b", from: Q["Universal Algebra"], to: Q["Hurwitz's Theorem (ℝ ℂ ℍ 𝕆)"], concept: "division algebras" },
  { id: "20000000-0000-0000-0000-00000000000c", from: Q["Universal Algebra"], to: Q["Grassmann / Exterior Algebra"], concept: "exterior algebra" },
  { id: "20000000-0000-0000-0000-00000000000d", from: Q["Hurwitz's Theorem (ℝ ℂ ℍ 𝕆)"], to: Q["Clifford Algebra Cl(V,Q)"], concept: "ℍ = even subalgebra" },
  { id: "20000000-0000-0000-0000-00000000000e", from: Q["Grassmann / Exterior Algebra"], to: Q["Clifford Algebra Cl(V,Q)"], concept: "+ quadratic form Q" },
  // Phase V
  { id: "20000000-0000-0000-0000-00000000000f", from: Q["Clifford Algebra Cl(V,Q)"], to: Q["τ and Rotors"], concept: "e^{-Bθ/2}" },
  { id: "20000000-0000-0000-0000-000000000010", from: Q["Infinitesimal Systems (ℝ*, Surreals)"], to: Q["Three Derivatives, One Spec"], concept: "standard-part" },
  { id: "20000000-0000-0000-0000-000000000011", from: Q["Three Derivatives, One Spec"], to: Q["SIA Infinitesimals (Kock–Lawvere)"], concept: "Kock–Lawvere derivative (meet)" },
  // Phase VI
  { id: "20000000-0000-0000-0000-000000000012", from: Q["Clifford Algebra Cl(V,Q)"], to: Q["The GA Substrate"], concept: "geometric product" },
  { id: "20000000-0000-0000-0000-000000000013", from: Q["τ and Rotors"], to: Q["The GA Substrate"], concept: "rotors" },
  { id: "20000000-0000-0000-0000-000000000014", from: Q["The GA Substrate"], to: Q["Maxwell: ∇F = J/ε₀c"], concept: "F as one bivector" },
  { id: "20000000-0000-0000-0000-000000000015", from: Q["The GA Substrate"], to: Q["Dirac in Real GA"], concept: "even-multivector spinor" },
  // Phase VII
  { id: "20000000-0000-0000-0000-000000000016", from: Q["The GA Substrate"], to: Q["Qubit = Spinor"], concept: "Cl⁺(3,0)≅ℍ≅SU(2)" },
  { id: "20000000-0000-0000-0000-000000000017", from: Q["Dirac in Real GA"], to: Q["Qubit = Spinor"], concept: "spinors" },
  { id: "20000000-0000-0000-0000-000000000018", from: Q["Qubit = Spinor"], to: Q["Gates as Rotors"], concept: "ψ' = RψR†" },
  { id: "20000000-0000-0000-0000-000000000019", from: Q["Gates as Rotors"], to: Q["Multi-Qubit & Entanglement"], concept: "tensor structure" },
  // Phase VIII
  { id: "20000000-0000-0000-0000-00000000001a", from: Q["The GA Substrate"], to: Q["GA-Equivariant AI & EML"], concept: "equivariance" },
  { id: "20000000-0000-0000-0000-00000000001b", from: Q["Hehner Predicative Logic"], to: Q["GA-Equivariant AI & EML"], concept: "EML / predicative" },
  { id: "20000000-0000-0000-0000-00000000001c", from: Q["Ostrowski & the p-adics"], to: Q["GA-Equivariant AI & EML"], concept: "ultrametric nets" },
];
